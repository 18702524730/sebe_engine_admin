<template>
	<div class="upload_wrap">
		...
		<div class="file-uploader" :class="{'file-uploader-onbg': startShow}" @click="addFile">
			...
			<el-progress type="circle" :percentage="progress" :status="uploadStatus" :width="94" :stroke-width="4" v-if="!ishtml4 && (uploadStatus || progress!=='100.00') && startShow"></el-progress>
			<div v-if="uploadedFileData.url">
				<div class="success successImg" v-if="isPdf(suffix)">
					<!-- <img :src="pdfPreviewImg"> -->
					<p class="name">{{processedFileName}}</p>
					<div class="mask"></div>
					<div class="hoveraction"><i class="el-icon-zoom-in" @click="openpdf"></i><i class="el-icon-close" @click.stop="handleRemove()"></i></div>
				</div>
				<div class="success successImg" v-else-if="isImg(suffix)" @mouseenter="dialogImageUrl=url">
					<img :src="url">
					<div class="mask"></div>
					<div class="hoveraction"><i class="el-icon-zoom-in" @click="dialogImgVisible=true"></i><i class="el-icon-close" @click.stop="handleRemove()"></i></div>
				</div>
